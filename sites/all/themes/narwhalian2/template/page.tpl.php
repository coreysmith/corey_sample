...
?>
<div class="page narwhalian cellar">
    ...
    <div id="header-wrapper" class="header-wrapper fullwidth">
      <div id="header-container" class="container">
        <div id="header" class="header row sixteen columns clearfix">
          ...
          <div id="site-info" class="site-info row seven columns alpha">
  ...
  <div id="secondary-wrapper">
    <div id="secondary-inner" class="container">
        ...
        <div id="secondary-navigation" class="row nine columns omega"><div class="inner">
          ...
          <?php if ($page['header']): ?>
            <div id="header-region" class="region row sixteen columns clearfix"><div class="inner">
