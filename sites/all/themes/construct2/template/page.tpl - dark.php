...
?>
<div class="page construct cellar dark-region">
    ...
    <div id="header-wrapper" class="header-wrapper fullwidth">
      <div id="header-container" class="container">
        <div id="header" class="header row sixteen columns clearfix">
          ...
          <div id="site-info" class="site-info row sixteen columns alpha omega">
          ...
          <?php if ($page['header']): ?>
            <div id="header-region" class="region row sixteen columns alpha omega"><div class="inner">
