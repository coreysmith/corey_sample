...
?>
<div class="page akihabara2 cellar">
  ...
  <div id="page-wrapper">
    ...
    <div id="secondary-wrapper">
      <div id="secondary-inner" class="container dark-region">
  ...
  <div id="content-area-wrapper">
    ...
    <div id="postscript-wrapper" class="postscript-wrapper fullwidth">
      ...
      <div id="postscript-container" class="container">
        <div id="postscript-container-inner" class="clearfix dark-region">
    ...
    <?php if ($page['footer']): ?>
    <div id="footer-wrapper" class="footer-wrapper fullwidth dark-region">
