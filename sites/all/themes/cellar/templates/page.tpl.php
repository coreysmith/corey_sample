  ...
  <div id="page-wrapper">
    ...
    <div id="secondary-wrapper">
      <div id="secondary-inner" class="container">
          ...
          </div></div></div> <!-- /.inner, /#secondary-navigation -->
...
<?php if ($main_menu || $page['main_nav']): ?>               
  <div id="navigation-wrapper" class="navigation-wrapper fullwidth">               
...
<!-- end main-navigation --> 
  ...
  <div id="content-area-wrapper">
    ...
    <div id="mobile-only-wrapper" class="mobile-only-wrapper fullwidth">
