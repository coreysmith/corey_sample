...
?>
<div class="page gallery prosperous2 cellar">
  ...
  <div id="content-area-wrapper">
      ...
      <div id="content-container" class="container <?php if ($page['preface']): ?>preface-yes<?php endif; ?>">
        ...
        <div class="inner content-container-inner clearfix">
          ...
          <?php if ($page['mobile_only']): ?>
            ...
            <div id="mobile-only-container" class="container dark-region">
          ...
          <?php if ($page['preface']): ?>
          <div id="preface-wrapper" class="preface-wrapper fullwidth dark-region">
        ...
        <div id="main-content-wrapper" class="main-content row sixteen columns clearfix <?php if ($main_menu || $page['main_nav']): ?>main-content-nav-yes<?php endif; ?>">
          ...
          <div id="content-column" class="content-column dark-region <?php print $contentclass; ?>">

            <?php if ($page['content_top']): ?>
              <div id="content-top" class="region dark-region padded-10"><div class="inner">
    ...
    <div id="postscript-wrapper" class="postscript-wrapper fullwidth dark-region">
