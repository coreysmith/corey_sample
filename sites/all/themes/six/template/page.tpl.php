...
<div class="page six cellar">
  ...
  <div id="header-wrapper-outer">
    ...
    <div id="header-wrapper" class="header-wrapper fullwidth">
      <div id="masthead-header-container" class="container">
        <div id="header" class="header row six columns clearfix">

         

          <div id="site-info" class="site-info row six columns alpha omega">
            <div class="inner">
      ...
      <?php if ($page['header']): ?>
        ...
        <div id="header-region" class="region sixteen columns"><div class="inner">
          <?php print render($page['header']); ?>
        </div></div> </div></div><!-- /.inner, /#header -->
      <?php endif; ?>
