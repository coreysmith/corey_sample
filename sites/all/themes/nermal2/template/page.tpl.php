...
?>
<div class="page prospect cellar">
...
<div class="secondary-wrapper-outer">
        ...
        <div id="secondary-navigation" class="row sixteen columns alpha omega"><div class="inner">
          <?php print theme('links__system_secondary_menu', array('links' => $secondary_menu, 'attributes' => array('id' => 'secondary-menu', 'class' => array('links', 'inline', 'clearfix')))); ?>
				...
				</div> <!-- /.inner, /#secondary-navigation -->
    	</div><!-- #secondary-inner -->
        ...
        <div id="main-content-wrapper" class="main-content row sixteen columns clearfix <?php if ($main_menu || $page['main_nav']): ?>main-content-nav-yes<?php endif; ?>">
          ...
          <div id="content-column" class="content-column <?php print $contentclass; ?>">
            ...
            <div id="content" class="content">
              ...
              <?php if ($title): ?><h1 class="title" id="page-title"><span class="page-title-span"><?php print $title; ?></span></h1><?php endif; ?>
