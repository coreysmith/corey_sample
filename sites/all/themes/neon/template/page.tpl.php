...
?>
<!-- cellar -> neon -->
<div id="page" class="page neon cellar">
  ...
  <div id="page-wrapper">
    ...
    <div id="header-wrapper" class="dark-region header-wrapper fullwidth">
      <div id="header-container" class="container">
        <div id="header" class="header row sixteen columns clearfix">
          ...
          <?php if ($page['search']): ?>
            <div id="search" class="region row eight columns omega"><div class="inner">
          ...
          <?php if ($main_menu): ?>
              ...
              <div id="main-navigation-region" class="main-navigation-region">
                <div class="inner">
  ...
  <div id="content-area-wrapper" class="dark-region">
    ...
    <?php if ($page['footer']): ?>
    <div id="footer-wrapper" class="dark-region footer-wrapper fullwidth">
    ...
    <?php endif; ?>
    <div id="attribution-line" class="fullwidth dark-region">
